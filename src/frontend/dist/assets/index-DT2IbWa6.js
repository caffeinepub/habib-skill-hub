      ...
      (entries) => {
        for (const entry of entries) {
          if (entry.isIntersecting) {
            ...
            for (const bar of bars) bar.classList.add("animate");
          }
        }
      },
      { threshold: 0.3 }
...
const services = [
  {
    icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Target, { className: "w-7 h-7" }),
  ...
  {
    icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Share2, { className: "w-7 h-7" }),
  ...
  {
    icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Funnel, { className: "w-7 h-7" }),
...
const testimonials = [
  {
    ...
    quote: "Habib completely transformed our lead generation. Within just 2 months we went from 10 leads per week to over 40. The ROI has been incredible — I wish I'd found him sooner.",
    rating: 5,
    initials: "SM",
    color: "purple"
  },
  {
    ...
    quote: "Our monthly appointments literally doubled. Habib genuinely understands healthcare marketing — he's not just running ads, he's growing your practice with real strategy.",
    rating: 5,
    initials: "JN",
    color: "blue"
  },
  {
    ...
    quote: "We saw a 180% jump in online traffic and a noticeable boost in walk-in customers within weeks. Professional, responsive, and delivers beyond what he promises.",
    rating: 5,
    initials: "MG",
    color: "purple"
  }
    ...
    "header",
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container mx-auto px-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            className: `flex items-center justify-between px-6 py-3 rounded-2xl transition-all duration-500 ${scrolled ? "glass-card shadow-lg" : "bg-transparent"}`,
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "a",
                {
                  ...
                  "data-ocid": "nav.link",
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "w-9 h-9 rounded-xl gradient-bg flex items-center justify-center font-display font-bold text-white text-sm", children: "H" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-display font-bold text-lg gradient-text hidden sm:block", children: "Habib Skill Hub" })
                  ]
                }
              ),
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "hidden md:flex items-center gap-3", children: /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "#contact", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                Button,
                {
        ...
        mobileOpen && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "md:hidden mt-2 glass-card rounded-2xl p-4 flex flex-col gap-1", children: [
...
function HeroSection() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "section",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 grid-dot-bg opacity-30" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "relative z-10 container mx-auto px-4 text-center", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-4xl mx-auto", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "inline-flex items-center gap-2 glass-card px-4 py-2 rounded-full mb-6 animate-fadeInUp", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "w-2 h-2 rounded-full bg-emerald-400 animate-pulse" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm text-muted-foreground font-medium", children: "Available for New Projects" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("h1", { className: "font-display font-bold text-5xl md:text-7xl lg:text-8xl xl:text-[6rem] leading-[1.05] mb-8 animate-fadeInUp tracking-tight", children: [
            "I Help Businesses Scale to",
            " ",
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "gradient-text", children: "6-Figure Revenue" }),
            " with Digital Marketing"
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-lg md:text-xl text-muted-foreground/90 mb-10 animate-fadeInUp tracking-wide font-medium", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-foreground/90", children: "Facebook Ads Expert" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "mx-3 gradient-text font-bold text-xl", children: "✦" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-foreground/90", children: "SEO Specialist" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "mx-3 gradient-text font-bold text-xl", children: "✦" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-foreground/90", children: "Lead Generation Pro" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col sm:flex-row items-center justify-center gap-4 mb-14 animate-fadeInUp", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "#contact", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
              Button,
              {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap items-center justify-center gap-6", children: [
            ...
            "div",
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-display font-bold text-2xl gradient-text", children: stat.num }),
...
function AboutSection() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "about", className: "py-24 relative", "data-ocid": "about.section", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "container mx-auto px-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid md:grid-cols-2 gap-12 lg:gap-20 items-center", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "section-reveal-left flex justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative w-72 h-80 lg:w-80 lg:h-96 rounded-3xl overflow-hidden neon-border-purple animate-pulse-glow", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "img",
          {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute -bottom-4 -right-4 glass-card neon-border-blue rounded-2xl px-4 py-3 animate-float", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-display font-bold text-xl gradient-text-blue", children: "2+" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-muted-foreground", children: "Years Exp." })
      ] })
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "section-reveal-right", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { className: "mb-4 gradient-bg border-0 text-white font-medium", children: "About Me" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "font-display font-bold text-3xl lg:text-4xl mb-5", children: [
        "Turning Digital Strategies into",
        " ",
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "gradient-text", children: "Real Revenue" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-muted-foreground leading-relaxed mb-8", children: [
        ...
        ", a passionate Digital Marketing Expert with 2+ years of hands-on experience helping businesses generate leads, increase ROI, and dominate their market online. I specialize in Facebook Ads, SEO, and lead generation systems that deliver real, measurable results."
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-3 gap-4 mb-8", children: [
        ...
        "div",
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-display font-bold text-xl gradient-text", children: m.num }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-muted-foreground mt-1", children: m.label })
          ]
        },
        m.label
      )) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { id: "skills-container", className: "space-y-4", children: skills.map((skill) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between text-sm mb-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-medium text-foreground", children: skill.name }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-muted-foreground", children: [
            skill.pct,
            "%"
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-full h-1.5 rounded-full bg-muted", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
...
function ServicesSection() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "section",
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container mx-auto px-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-14 section-reveal", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { className: "mb-4 gradient-bg border-0 text-white font-medium", children: "What I Offer" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "font-display font-bold text-3xl lg:text-4xl", children: [
            "Services That Drive",
            " ",
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "gradient-text", children: "Measurable Growth" })
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid sm:grid-cols-2 lg:grid-cols-3 gap-6", children: services.map((s, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "div",
                {
                  className: `w-14 h-14 rounded-2xl flex items-center justify-center mb-5 ${s.color === "purple" ? "bg-primary/15 text-primary" : "bg-secondary/15 text-secondary"}`,
                  children: s.icon
                }
              ),
              /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display font-bold text-lg mb-3", children: s.title }),
...
function WhyChooseMeSection() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "py-24 relative", "data-ocid": "why.section", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container mx-auto px-4", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-14 section-reveal", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { className: "mb-4 gradient-bg border-0 text-white font-medium", children: "Why Choose Me" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "font-display font-bold text-3xl lg:text-4xl", children: [
        "Built on ",
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "gradient-text", children: "Results & Trust" })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid sm:grid-cols-2 lg:grid-cols-4 gap-6", children: whyChooseMe.map((item, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-14 h-14 rounded-2xl bg-primary/15 text-primary flex items-center justify-center mx-auto mb-5", children: item.icon }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display font-bold text-base mb-2", children: item.title }),
...
function PortfolioSection() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "section",
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container mx-auto px-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-14 section-reveal", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { className: "mb-4 gradient-bg border-0 text-white font-medium", children: "Success Stories" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "font-display font-bold text-3xl lg:text-4xl", children: [
            "Real Campaigns. ",
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "gradient-text", children: "Real Results." })
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid md:grid-cols-2 lg:grid-cols-3 gap-6", children: portfolio.map((p, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "div",
                {
                  className: `p-6 ${p.color === "purple" ? "bg-gradient-to-br from-primary/20 to-transparent" : "bg-gradient-to-br from-secondary/20 to-transparent"}`,
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      Badge,
                      {
                        className: `mb-3 text-xs ${p.color === "purple" ? "bg-primary/20 text-primary border-primary/30" : "bg-secondary/20 text-secondary border-secondary/30"}`,
                        children: p.category
                      }
                    ),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display font-bold text-lg mb-1", children: p.client }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "p",
                      {
                        className: `font-bold text-2xl ${p.color === "purple" ? "gradient-text" : "gradient-text-blue"}`,
                        children: p.headline
                      }
                    )
                  ]
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-6 space-y-3", children: p.results.map((r2) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "div",
                {
                  className: "flex justify-between items-center",
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm text-muted-foreground", children: r2.label }),
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 text-sm", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-destructive/80 line-through", children: r2.before }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx(ChevronRight, { className: "w-3 h-3 text-muted-foreground" }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-bold text-emerald-400", children: r2.after })
                    ] })
                  ]
                },
                r2.label
...
function TestimonialsSection() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "py-24 relative", "data-ocid": "testimonials.section", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container mx-auto px-4", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-14 section-reveal", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { className: "mb-4 gradient-bg border-0 text-white font-medium", children: "Client Reviews" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "font-display font-bold text-3xl lg:text-4xl", children: [
        "What My Clients ",
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "gradient-text", children: "Say About Me" })
      ] })
    ] }),
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "div",
              {
                className: `w-10 h-10 rounded-full flex items-center justify-center font-bold text-sm text-white ${t.color === "purple" ? "gradient-bg" : "bg-secondary"}`,
                children: t.initials
              }
            ),
...
function PricingSection() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "section",
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container mx-auto px-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-14 section-reveal", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { className: "mb-4 gradient-bg border-0 text-white font-medium", children: "Pricing" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "font-display font-bold text-3xl lg:text-4xl", children: [
            "Transparent Packages for",
            " ",
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "gradient-text", children: "Every Stage" })
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid md:grid-cols-3 gap-6 max-w-5xl mx-auto", children: pricing.map((plan, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            className: `section-reveal rounded-2xl p-6 flex flex-col relative ${plan.popular ? "pricing-popular scale-[1.08] z-10" : "glass-card-hover"}`,
            style: { transitionDelay: `${i * 80}ms` },
            "data-ocid": `pricing.item.${i + 1}`,
            children: [
              plan.popular && /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute top-0 left-0 right-0 h-1 rounded-t-2xl bg-gradient-to-r from-violet-500 via-purple-400 to-blue-500" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute -top-4 left-1/2 -translate-x-1/2", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { className: "gradient-bg border-0 text-white text-xs px-4 py-1.5 font-bold tracking-widest shadow-lg shadow-purple-500/40", children: "★ MOST POPULAR" }) })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-6", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display font-bold text-xl mb-1", children: plan.name }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-sm mb-4", children: plan.desc }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-end gap-1", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-display font-bold text-4xl gradient-text", children: plan.price }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-muted-foreground mb-1", children: plan.period })
                ] })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "space-y-3 flex-1 mb-6", children: plan.features.map((f) => /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "flex items-center gap-3 text-sm", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(CircleCheck, { className: "w-4 h-4 text-emerald-400 flex-shrink-0" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-muted-foreground", children: f })
              ] }, f)) }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "#contact", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                Button,
                {
                  "data-ocid": `pricing.primary_button.${i + 1}`,
                  className: `w-full rounded-xl font-semibold border-0 ${plan.popular ? "gradient-btn text-white" : "bg-white/10 hover:bg-white/15 text-foreground"}`,
...
function ContactSection() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "section",
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container mx-auto px-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-14 section-reveal", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { className: "mb-4 gradient-bg border-0 text-white font-medium", children: "Get In Touch" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "font-display font-bold text-3xl lg:text-4xl", children: [
            "Ready to ",
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "gradient-text", children: "Scale Your Business?" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground mt-3 max-w-xl mx-auto", children: "Let's discuss your project and see how I can help you hit your marketing goals." })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid lg:grid-cols-2 gap-12 max-w-5xl mx-auto", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "section-reveal-left space-y-6", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display font-bold text-xl mb-6", children: "Contact Information" }),
            [
              {
              ...
              "a",
              {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-11 h-11 rounded-xl bg-primary/15 text-primary flex items-center justify-center", children: item.icon }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-muted-foreground", children: item.label }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-sm font-medium group-hover:text-primary transition-colors", children: item.value })
                  ] })
                ]
              },
              item.label
            )),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex gap-3 pt-4", children: [
              {
                icon: /* @__PURE__ */ jsxRuntimeExports.jsx(SiFacebook, {}),
                href: "https://www.facebook.com/share/1CdhgyhRwr/",
                label: "Facebook"
              },
              {
                icon: /* @__PURE__ */ jsxRuntimeExports.jsx(SiInstagram, {}),
                href: "https://www.instagram.com/habib.marketor",
                label: "Instagram"
              },
              {
                icon: /* @__PURE__ */ jsxRuntimeExports.jsx(SiLinkedin, {}),
                href: "https://www.linkedin.com/in/md-habib-molla-33734937a",
                label: "LinkedIn"
              },
              {
                icon: /* @__PURE__ */ jsxRuntimeExports.jsx(SiWhatsapp, {}),
                href: "https://wa.me/8801931353304",
                label: "WhatsApp"
              }
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "section-reveal-right", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "form",
            {
              ...
              children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  Button,
                  {
                    ...
                    children: submitted ? /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "flex items-center gap-2", children: [
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "footer",
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container mx-auto px-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid md:grid-cols-4 gap-10 mb-12", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "md:col-span-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mb-4", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "w-9 h-9 rounded-xl gradient-bg flex items-center justify-center font-display font-bold text-white text-sm", children: "H" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-display font-bold text-xl gradient-text", children: "Habib Skill Hub" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-sm leading-relaxed max-w-xs", children: "Premium digital marketing services that turn clicks into clients and campaigns into revenue." }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "font-display font-bold text-sm mb-4", children: "Quick Links" }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "font-display font-bold text-sm mb-4", children: "Services" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "space-y-2", children: [
              ...
              "Social Media",
              "Funnel Building"
            ].map((s) => /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(
              "a",
              {
                href: "#services",
                "data-ocid": "footer.link",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "border-t border-border/40 pt-6 flex flex-col sm:flex-row items-center justify-between gap-3 text-xs text-muted-foreground", children: [
...
function WhatsAppButton() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "a",
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsx(SiWhatsapp, {})
    }
  );
}
function App() {
  ...
  useProgressBars();
  reactExports.useEffect(() => {
    document.title = "Habib Hosen | Digital Marketing Expert – Facebook Ads, SEO & Lead Generation";
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen bg-background text-foreground overflow-x-hidden", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(WhyChooseMeSection, {}),
